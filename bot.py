...
def run_pipeline(task: str) -> dict:
    """Run the ULTRON content pipeline (everything except posting)."""
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    welcome = (
        "🤖 *Welcome to ULTRON — Your AI Digital Agency*\n\n"
...
async def _handle_regenerate(query, user_id, context):
    ...
    await query.edit_message_text(
        ...
        "Running the ULTRON pipeline again...",
        parse_mode="Markdown",
    )
...
def main():
    print("\n" + "=" * 60)
    print("🤖 ULTRON Telegram Bot — Starting...")
    print("=" * 60)
